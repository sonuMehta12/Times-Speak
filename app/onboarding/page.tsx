...
export default function OnboardingPage() {
  ...
  const AIPrompt: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <div className="flex items-start gap-3 mb-6 animate-fade-in-up">
      ...
      <Card className="flex-1 border-gray-200 rounded-[20px] rounded-tl-none bg-gray-50">
        <CardContent className="p-4">
          <p className="text-sm text-text-primary leading-relaxed font-body">{children}</p>
        </CardContent>
      </Card>
    </div>
  );
        ...
        return (
          <div className="space-y-6">
              ...
              <div className="relative aspect-video bg-gradient-to-br from-navy via-teal to-coral flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-xs opacity-80 font-body">2:30 min</p>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Button
              ...
              className="w-full bg-coral text-white hover:bg-coral-hover py-4 rounded-[16px] font-semibold shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {videoWatched ? 'Start Learning' : 'Watch Video to Continue'}
            </Button>
            
            {!videoWatched && (
              <p className="text-xs text-center text-text-secondary font-body">
                Tap the play button above to watch the video
              </p>
            )}
          </div>
        );
